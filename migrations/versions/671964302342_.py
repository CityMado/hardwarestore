...
Revision ID: 671964302342
Revises: 
Create Date: 2020-12-11 15:53:14.334175
...
def upgrade():
    ...
    sa.Column('date_of_sale', sa.Integer(), nullable=True),
    sa.Column('sale_amount', sa.Integer(), nullable=True),
    sa.Column('who_sold', sa.String(length=1000), nullable=True),
